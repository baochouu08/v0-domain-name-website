...
// <CHANGE> updated metadata for domain marketplace
export const metadata: Metadata = {
  title: "DomainHub - Premium Domain Names",
  description: "Buy and register premium domain names for your business. Fast, secure, and affordable.",
  generator: "v0.app",
  icons: {
    icon: [
      {
